            ...
            <div class="contact-home">
                ...
                <div class="contact-form">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="row g-3 needs-validation" novalidate method="post">
                        ...
                        <div class="col-lg-12">
                            <input type="email" name="email" class="form-control" id="email" placeholder="Email" style="box-shadow: none !important; outline: none !important; border: 1px solid #279EFF;" required>
                            <div class="invalid-feedback">
                                Please enter your Email Address.
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <input type="number" name="number" class="form-control" id="number" placeholder="Phone Number" style="box-shadow: none !important; outline: none !important; border: 1px solid #279EFF;" required>
                            <div class="invalid-feedback">
                                Please enter your Phone Number.
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <input type="text" name="message" class="form-control" id="message" placeholder="Message" style="box-shadow: none !important; outline: none !important; border: 1px solid #279EFF;" required>
                            <div class="invalid-feedback">
