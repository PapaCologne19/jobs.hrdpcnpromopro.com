...
if ($result) {
    while ($row = $result->fetch_assoc()) {
        ...
        $template = "../../portal.hrdpcnpromopro.com/admin/loa_template_directory/" . $file_name;
        ...
        while ($selected_row = $selected_result->fetch_assoc()) {
            ...
            $select_folder_path_result = $con->query($select_folder_path);
            ...
            $destination_subfolder = "../" . $folder_path . "/";
