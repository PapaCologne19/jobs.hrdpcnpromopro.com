...
<body id="about">
    ...
    <div class="about-homepages">
        <div class="about-home">
          ...
          <p style="text-indent: 5rem;">We are proud to be one of the pioneers in the BTL industry in the Philippines, with over 31 years of experience.</p>
          <p style="text-indent: 5rem;">We have continuously grown in size, volume and clientele over the years through our passion for excellence, fearless out-of-the-box solutions and strong commitment to lasting partnerships.</p>
          <h5 class="fs-4 mt-5">Our Mission</h5>
          <p style="text-indent: 2rem;">To provide effective and reliable Marketing and Sales Solutions with our local expertise and global competitiveness.</p>
          <h5 class="fs-4 mt-5">Our Vision</h5>
          <p style="text-indent: 2rem;">To be the leader in the Marketing and Sales Solutions industry by: <br>
            <ul>
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingOne">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="true" aria-controls="flush-collapseOne" style="box-shadow: none;">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample" style="box-shadow: none;">
                            <div class="accordion-body">For the best and most compatible experience, we recommend that you submit your resume in PDF and Docx format. This will ensure that the formatting and layout of your resume is preserved and easily viewable for our hiring team.</div>
                        </div>
                    </div>
